...
import (
	...
	versionedscheme "knative.dev/eventing-camel/pkg/client/clientset/versioned/scheme"
	client "knative.dev/eventing-camel/pkg/client/injection/client"
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.knative.dev.CamelSource"),
	)
