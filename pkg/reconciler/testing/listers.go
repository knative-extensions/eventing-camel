...
import (
	...
	fakesourcesclientset "knative.dev/eventing-camel/pkg/client/clientset/versioned/fake"
	sourceslisters "knative.dev/eventing-camel/pkg/client/listers/sources/v1alpha1"
)
